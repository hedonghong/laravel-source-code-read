...
class ComposerStaticInitf98e46180a57e99b3e258e69ac1b8f28
{
    ...
    public static $classMap = array (
        ...
        'Laravel\\AnimalInterface' => __DIR__ . '/../..' . '/src/AnimalInterface.php',
        'Laravel\\Cat' => __DIR__ . '/../..' . '/src/Cat.php',
        'Laravel\\Dog' => __DIR__ . '/../..' . '/src/Dog.php',
        'Laravel\\Girl' => __DIR__ . '/../..' . '/src/Girl..php',
        'Laravel\\People' => __DIR__ . '/../..' . '/src/People.php',
        'Laravel\\People1' => __DIR__ . '/../..' . '/src/People1.php',
        'Laravel\\People2' => __DIR__ . '/../..' . '/src/People2.php',
        'Laravel\\PersonInterface' => __DIR__ . '/../..' . '/src/PersonInterface.php',
        'Laravel\\Rongqi\\Rongqi1' => __DIR__ . '/../..' . '/src/Rongqi/Rongqi1.php',
        'Laravel\\Rongqi\\Rongqi2' => __DIR__ . '/../..' . '/src/Rongqi/Rongqi2.php',
        'Laravel\\Rongqi\\Rongqi3' => __DIR__ . '/../..' . '/src/Rongqi/Rongqi3.php',
        'Laravel\\Tests\\IocTest' => __DIR__ . '/../..' . '/tests/IocTest.php',
    ...
    {
        #Closure::bind的作用是什么可以百度或者https://www.php.net/manual/zh/closure.bind.php
        #prefixLengthsPsr4、prefixDirsPsr4、fallbackDirsPsr4、prefixesPsr0、classMap在ClassLoader类中都是私有类变量
        #那么私有类变量只能内部使用，这个时候可以通过闭包函数bind绑定外部方法的方式给内部私有变量赋值
        return \Closure::bind(function () use ($loader) {
            ...
            而 PSR4标准 却是用顶级命名空间目录替换顶级命名空间，所以获得顶级命名空间的长度很重要。
                Parsedown/example => __DIR__ . '/..' . '/erusev/parsedown/example.php
                                                                ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
            具体的用法：假如我们在$prefixLengthsPsr4中找 Symfony\Polyfill\Mbstring这个命名空间的一个类Symfony\Polyfill\Mbstring\example 这个命名空间，我们得到了
                'Symfony\\Polyfill\\Mbstring\\' => 26, 注意\\在实际中只有一条\
            这条记录，键是顶级命名空间，值是命名空间的长度。拿到顶级命名空间后去$prefixDirsPsr4数组 获取它的映射目录数组：(注意映射目录可能不止一条)
                'Symfony\\Polyfill\\Mbstring\\' => array (
                    0 => __DIR__ . '/..' . '/symfony/polyfill-mbstring',
                )
            然后我们就可以将命名空间 Symfony\Polyfill\Mbstring\example 前26个字符替换成目录 __DIR__ . '/..' . '/symfony/polyfill-mbstring ，
            我们就得到了__DIR__ . '/..' . '/symfony/polyfill-mbstring/example.php，先验证磁盘上这个文件是否存在，如果不存在接着遍历。
            如果遍历后没有找到，则加载失败。
            */
            #$prefixLengthsPsr4顶级域名对应的字符串长度
            $loader->prefixLengthsPsr4 = ComposerStaticInitf98e46180a57e99b3e258e69ac1b8f28::$prefixLengthsPsr4;
            #$prefixLengthsPsr4顶级域名对应的目录数组
            $loader->prefixDirsPsr4 = ComposerStaticInitf98e46180a57e99b3e258e69ac1b8f28::$prefixDirsPsr4;
            #PSR4后备目录
            $loader->fallbackDirsPsr4 = ComposerStaticInitf98e46180a57e99b3e258e69ac1b8f28::$fallbackDirsPsr4;
            #PSR0 顶级命名空间映射
            #使用时以顶级命名空间首个字母作为前缀查找出对应的顶级命名空间数组，并且循环查找匹配
            /*'P' =>
            array (
                'Prophecy\\' =>
                    array (
            ...
            $loader->prefixesPsr0 = ComposerStaticInitf98e46180a57e99b3e258e69ac1b8f28::$prefixesPsr0;
            #$classMap直接命名空间全名与目录的映射
            $loader->classMap = ComposerStaticInitf98e46180a57e99b3e258e69ac1b8f28::$classMap;
